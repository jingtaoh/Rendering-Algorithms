...
void test_vectors_and_matrices()
{
    ...
    // But darts also provides some output functions (message, success, warning, error).
    // These operate like fmt::print, but colorize the output based on the type of message.
